#!/usr/bin/env python3
"""
Land Use Vision Model Fine-Tuning Script for Sub-Saharan Africa (Google Colab Edition)

Instructions:
1. Upload this script and `classification_dataset_sub_saharan_africa.zip` to your Google Drive.
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", default="/content/classification_dataset_sub_saharan_africa", help="Dataset directory path")
    ...
    parser.add_argument("--output_model", default="/content/drive/MyDrive/models/landuse_sub_saharan_africa_efficientnet_v2_s.pth", help="Save path for fine-tuned weights")
