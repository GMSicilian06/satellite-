...
# 11 South American cities
CITIES = [
    "Belo Horizonte", "Bogota", "Cabimas", "Caracas", "Cochabamba", "Cordoba",
    "Florianopolis", "Ilheus", "Palmas", "Quito", "Valledupar"
]
...
def main():
    ...
    for city in CITIES:
        ...
        # South American study circles are typically T1 shapefiles ending in 11.shp
        ending = "11.shp"
        ...
        for shp in valid_shps:
            ...
            if name in tifs:
                ...
                if len(selected_shps) >= 40:  # Evaluate up to 40 circles per city
                    break
    ...
    csv_path = "/Users/carlossequeira/Satellite/data/processed/south_america_r2_results.csv"
    ...
    artifact_paths = [
        "/Users/carlossequeira/.gemini/antigravity-ide/brain/1886d4a0-c314-40da-9625-5170fe657153/south_america_classification_comparison.md",
        "/Users/carlossequeira/Satellite/data/processed/south_america_classification_comparison.md"
    ]
    for path in artifact_paths:
        os.makedirs(os.path.dirname(path), exist_ok=True)
        with open(path, "w", encoding="utf-8") as f:
            f.write("# South American Land Use Classification Metrics Comparison\n\n")
            f.write("This report presents the aggregated land use metrics comparing the **fine-tuned South American model predictions** against the official **Atlas of Urban Expansion (AUE) ground truth** across all evaluated cities.\n\n")
