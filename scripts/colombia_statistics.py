...
def main():
    parser = argparse.ArgumentParser(description="Orchestrate land use statistics for Colombian cities.")
    ...
    print("\n\n" + "X"*70)
    print(" AGGREGATED NATIONWIDE COLOMBIA STATISTICS")
    print("X"*70)
    print_stats_table(combined_df, "All Processed Colombian Cities")
